...
class DealersController extends Controller
{
	...
	*/
	public function actionIndex()
	{
        ...
        {
          $q = $_GET['q'];
          $criteria->compare('Prem_ZipCode', $q, true, 'OR');
          $criteria->compare('Mail_ZipCode', $q, true, 'OR');
        }

        $dataProvider=new CActiveDataProvider("Dealers", array('criteria'=>$criteria));
    ...
    public function actionSearch()
    {
        ...
        if(isset($_POST['ajax']) && $_POST['ajax']==='dealers-search-form')
        {
